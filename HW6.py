...
def cache_all_pages(people_url, filename):
    ...
    while page < 10:
        if str(page) not in cache:
            page_results = get_swapi_info(people_url, params = "page=" + str(page))['results']
            cache["page " + str(page)] = page_results
        ...
        for person in page:
            ...
            if person['starships']:
                ...
                for starship_url in person['starships']:
                    starship_name = get_swapi_info(starship_url)
                    starships.append(starship_name['name'])
